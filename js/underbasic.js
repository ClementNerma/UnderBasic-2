...
const UnderBasic = (new (function() {
  ...
  UBL.functions = {
    ...
    "LinReg_a+bx": ['void', '[list*]', '[list*]'],
    "LinReg_ax+b": ['void', '[list*]', '[list*]'],
    LinRegTInt: ['void', 'list*', 'list*', 'list*', 'number*', 'yvar*'],
    LinRegTTest: ['void', 'list*', 'list*'],
    "^List": ['list', 'list'],
    ...
    Logistic: ['void', 'list*', 'list*'],
    "Manual-Fit": ['void', 'yvar*'],
    MATHPRINT: ['void'],
    "Matr>List": ['void', 'matrix', 'list*'],
    max: ['number', 'number', 'number'],
    mean: ['number', 'list', '[list]'],
    median: ['number', 'list', '[list]'],
    "Med-Med": ['void', 'list*', 'list*', 'list*', 'number*', 'yvar*'],
    ...
    Param: ['void'],
    Pause: ['void', '[string]'],
    PlotsOff: ['void', 'number', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]'],
    PlotsOn: ['void', 'number', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]', '[number]'],
    Pmt_Bgn: ['void'],
    Pmt_End: ['void'],
    ...
    Prompt: ['void', 'number*'],
    "1-PropZInt": ['void', 'number', 'number', '[number]'],
    "2-PropZInt": ['void', 'number', 'number', '[number]'],
    "1-PropZTest": ['void', 'number', 'number', 'number', '[number]', '[number]'],
    "2-PropZTest": ['void', 'number', 'number', 'number', '[number]', '[number]'],
    "Pt-Change": ['void', 'number', 'number'],
    "Pt-Off": ['void', 'number', 'number', '[number]'],
    "Pt-On": ['void', 'number', 'number', '[number]'],
    PwrReg: ['void', '[list*]', '[list*]'],
    ...
    QuadReg: ['void', '[list*]', '[list*]'],
    QuartReg: ['void', '[list*]', '[list*]'],
    Radian: ['void'],
    ...
    SinReg: ['void', 'list*', 'list*'],
    solve: ['void', 'expression', 'number*', 'number', 'list*'],
    SortA: ['void', 'list*'],
    SortD: ['void', 'list*'],
    startTmr: ['number'],
    ...
    "ZFrac1/10": ['void'],
    ZInteger: ['void'],
    ZInterval: ['void', 'number', 'list', 'number'],
    "Zoom In": ['void'],
    "Zoom Out": ['void'],
    ZoomFit: ['void'],
    ZoomRcl: ['void'],
    ...
    ZSquare: ['void'],
    ZStandard: ['void'],
    "Z-Test": ['void', 'number', 'number', 'list', 'number'],
    ZTrig: ['void']
  };
